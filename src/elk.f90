...
!BOI
! !TITLE: {\huge{\sc The Elk Code Manual}}\\ \Large{\sc Version 10.8.16}\\ \vskip 20pt \includegraphics[height=1cm]{elk_silhouette.pdf}
...
!
!   \block{nefvit}{
!   {\tt nefvit} & number of iterations the iterative eigenvalue solver should
!    perform per self-consistent loop & integer & 2}
!   If {\tt nefvit} is negative then the first-variational eigenvectors are
!   read in at the start of the self-consistent loop and the number of
!   iterations is its absolute value. See {\tt tefvit}.
!
!   \block{nempty}{
