...
!----------------------------------------------------------!
! combined target array for drhomt, drhoir, dmagmt and dmagir
complex(8), allocatable, target :: drhmg(:)
! density derivative
complex(8), pointer, contiguous :: drhomt(:,:),drhoir(:)
! magnetisation derivative
complex(8), pointer, contiguous :: dmagmt(:,:,:),dmagir(:,:)
