...
open(50,file='SYMLAT'//trim(filext),form='FORMATTED',action='WRITE')
...
open(50,file='SYMCRYS'//trim(filext),form='FORMATTED',action='WRITE')
write(50,*)
...
open(50,file='SYMSITE'//trim(filext),form='FORMATTED',action='WRITE')
write(50,*)
...
open(50,file='EQATOMS'//trim(filext),form='FORMATTED',action='WRITE')
do is=1,nspecies
  write(50,*)
